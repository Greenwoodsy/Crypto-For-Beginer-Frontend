...
const forumData = [
  ...
  },
  {
    id: 2,
    image: forum2,
    description: "An exclusive one-on-one discussion between a top investor and a key Crypto For Beginner team member."
  },
  {
    id: 3,
    image: forum3,
    description: "A successful investor proudly holding Crypto For Beginner merchandise, symbolizing financial triumph."
  },
  {
    id: 4,
    image: forum4,
  ...
  },
  {
    id: 5,
    image: forum5,
    description: "Another inspiring couple investing in their future with Crypto For Beginner’ expert strategies."
  }
];
...
const Forum = () => {
  return (
    <div className="forum-section">
      <h2 className="forum-header">Crypto For Beginner Investment Forum</h2>
