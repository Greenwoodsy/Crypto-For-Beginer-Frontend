  ...
  return (
    <section className="section-three">
      <div className="section-three-content">
        <h1 className="section-three-title">Why Invest with Crypto For Beginner?</h1>
        <p className="section-three-description">
          Discover how Crypto For Beginner makes your investments smarter and safer with
        ...
        <div className="section-three-cards">
          ...
          <div className="card">
            ...
            <p className="card-text">
              Unlock new avenues for financial growth with Crypto For Beginner.
            </p>
          </div>
        </div>
      </div>
